...
**La prochaine demande porte le numéro 24** (la 23 lance `menia-lora-full-mac` vers `run-12-full` ; l'enquête sur son adaptateur final suivra). Codemagic fige le commit à la
