...
20 septembre 2026. **Note de conception générale, pas un protocole confirmatoire.**
...
L'essai sur Qwen3-4B constate désormais un effet réversible, mais sous forme
d'effondrement du format des tâches et des rapports. Il ne fournit pas de
prévision native exploitable de cette conséquence.
...
flottant peut toutefois différer par l'ordre des réductions. Ce témoin est
désormais mesuré sur les 24 tâches du premier essai : les 24 rappels restent
corrects, avec des écarts de scores de prévision.
